            ...
            <div class="row clearfix">
                <div class="col-md-4 col-sm-6 col-md-offset-0">
                    <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms"
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="media-object" class="comimg" src="{{ asset('frontend/images/msa-committee/Nazim.jpg') }}"
                                    alt="" height="150px">
                            </div>
                            <div class="media-body">
                                <h4 class="whyisntitwhite">Nazim Khan</h4>
                                <h5 class="whyisntitwhite">Executive Officer</h5>
                                <ul class="social_icons">

                                    <li class="whyisntitwhite">Contact: <a
                                            href="mailto:nazim.khan@uwa.edu.au">nazim.khan@uwa.edu.au</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-md-offset-0">
                    <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms"
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="media-object" class="comimg" src="{{ asset('frontend/images/msa-committee/Mahirul.jpg') }}"
                                    alt="" height="150px">
                            </div>
                            <div class="media-body">
                                <h4 class="whyisntitwhite">Mahirul Chowdhury</h4>
                                <h5 class="whyisntitwhite">President</h5>
                                <ul class="social_icons">
                                    <li class="whyisntitwhite">Contact: <a
                                            href="mailto:President@uwamsa.org">president@uwamsa.org</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-md-offset-0">
                    <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms"
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="media-object" class="comimg" src="{{ asset('frontend/images/msa-committee/Fareeha.jpg') }}"
                                    alt="" height="150px">
                            </div>
                            <div class="media-body">
                                <h4 class="whyisntitwhite">Fareeha Khan</h4>
                                <h5 class="whyisntitwhite">Vice President</h5>
                                <ul class="social_icons">
                                    <li class="whyisntitwhite">Contact: <a
                                            href="mailto:vicepresident@uwamsa.org">vicepresident@uwamsa.org</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
